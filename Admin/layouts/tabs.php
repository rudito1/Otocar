        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-nav-item">
            ...
            <ul class="sidebar-sub-nav collapse show" id="navUI">
              ...
              <li class="sidebar-nav-item">
                <a href="./tabs.php" class="sidebar-nav-link active">
                  <span class="sidebar-nav-abbr">
                    Ta
                  </span>
                  <span class="sidebar-nav-name">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card mb-grid text-center">
                  <div class="card-header">
                    <ul class="nav nav-pills card-header-pills" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="card-tab-1" data-toggle="tab" href="#card-tab-content-1" role="tab" aria-controls="card-tab-content-1" aria-selected="true">Active</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="card-tab-2" data-toggle="tab" href="#card-tab-content-2" role="tab" aria-controls="card-tab-1" aria-selected="false">Link</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link disabled" id="card-tab-2" data-toggle="tab" href="#card-tab-content-3" role="tab" aria-controls="card-tab-2" aria-selected="false">Disabled</a>
                      </li>
                    </ul>
                  </div>
                  <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Seamless</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Tabs</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Example</a>
                  </li>
                </ul>
