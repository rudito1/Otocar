...
<html lang="en">
  <head>
    <title>AdminX - Notifications</title>
    <meta charset="utf-8">
              ...
              <div class="col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body collapse show" id="card1">
                    ...
                    <pre><code class="js">notification.fire('This is a notification');</code></pre>

                    <p>
                      Available options for a single notification
                    </p>

                    <pre><code class="js">notification.fire('This is a notification', {<br />&nbsp;&nbsp;autoHide: false,<br />&nbsp;&nbsp;playSound: true,<br />&nbsp;&nbsp;duration: 5000,<br />&nbsp;&nbsp;style: 'default',<br />});</code></pre>

                    <p>
                      Notifications need to be initalized before you can use them. It's as simple as:
                    </p>

                    <pre><code class="js">const notifications = new window.notifications();</code></pre>

                    <p>
                      There comes a set of options you can override on initialization.
                    </p>

                    <pre><code class="js">const notifications = new window.notifications({<br />&nbsp;&nbsp;notificationSound: '../dist/media/notification.mp3',<br />&nbsp;&nbsp;volume: 0.2,<br />&nbsp;&nbsp;notification: {<br />&nbsp;&nbsp;&nbsp;&nbsp;autoHide: false,<br />&nbsp;&nbsp;&nbsp;&nbsp;playSound: true,<br />&nbsp;&nbsp;&nbsp;&nbsp;duration: 5000,<br />&nbsp;&nbsp;&nbsp;&nbsp;style: 'default',<br />&nbsp;&nbsp;&nbsp;&nbsp;position: 'top',<br />&nbsp;&nbsp;}<br />});</code></pre>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    <form id="notificationDemo">
                      <div class="form-group">
                        <label class="form-label" for="demoText">Notification Text (html allowed)</label>
                        <input type="text" class="form-control" name="demoText" id="demoText" placeholder="Text" value="This is a notification">
                      </div>
                      <div class="form-group">
                        <label class="form-label" for="demoStyle">Style</label>
                        <select class="form-control" id="demoStyle" name="demoStyle">
                      ...
                      <div class="form-group">
                        <label class="form-label">Play sound?</label>
                        <div>
                          <label class="custom-control custom-radio">
                            <input id="demoSoundOn" name="demoSound" value="1" checked="checked" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">Yes</span>
                          </label>
                          <label class="custom-control custom-radio">
                            <input id="demoSoundOff" name="demoSound" value="0" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                      ...
                      <div class="form-group">
                        ...
                        <div>
                          <label class="custom-control custom-radio">
                            <input id="demoPositionTop" name="demoPosition" value="top" checked="checked" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">Top</span>
                          </label>
                          <label class="custom-control custom-radio">
                            <input id="demoPositionBototm" name="demoPosition" value="bottom" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">Bottom</span>
                          </label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="form-label">Auto hide notification</label>
                        <div>
                          <label class="custom-control custom-radio">
                            <input id="demoAutoHideYes" name="demoAutoHide" value="1" checked="checked" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">Yes</span>
                          </label>
                          <label class="custom-control custom-radio">
                            <input id="demoAutoHideNo" name="demoAutoHide" value="0" type="radio" class="custom-control-input">
                            <span class="custom-control-indicator"></span>
                            <span class="custom-control-description">No</span>
                          </label>
                        </div>
                      ...
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary">Fire Notification</button>
                      </div>
                    </form>
                  </div>
                </div>
