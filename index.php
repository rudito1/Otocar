        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/car.png" alt="">
                </div>
            </div>
        </div>
    </div> -->
                        ...
                        <div class="col-xl-7 col-lg-8 offset-xl-5 offset-lg-4">
                            <div class="office-pera">
                                <div class="section-tittle">
                                    <h2 class="mb-30">Kami memiliki peralatan terbaru</h2>
                                    <p>kami memiliki beberapa fasilitas yang pastinya dapat memuaskan pelanggan.  merupakan sebuah kegagalan bila pelanggan tidak puas dengan hasil kerja kami </p>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-10">
                        <div class="section-tittle text-center mb-90">
                            <h2>Kami menawarkan layanan terbaik kepada pelanggan kami</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-10 col-sm-11">
                        <div class="section-tittle mb-60">
                            <h2>Mengapa mengambil layanan kami?</h2>
                            <p>Otocar akan memberikan pelayanan terbaik bagi pelanggan</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="single-footer-caption mb-50">
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-tittle">
                                        ...
                                        <ul class="mb-40">
                                            <li class="number"><a href="#">(+62)8933357769</a></li>
